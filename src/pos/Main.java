...
public class Main extends javax.swing.JFrame {
  ...
  Dashboard dash;
    public Main() {
        initComponents();
        dash = new Dashboard();
        dash.setSize(this.getWidth(),this.getHeight());
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 50, 640));
        ...
        getContentPane().add(jDesktopPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 60, 1110, 640));
